...
data = pd.read_csv(r'//141.89.115.120/boye1/Auswertung/NbO2/20220824_113906/Spectro1_PumpProbe_AveragedData.txt', #windows
...
plt.title('Raw data - 500mW, small delays')
...
plt.title('Smooth data - 500mW, small delays')
plt.xlabel('Wavelength [nm]')
plt.ylabel('Stage Delay [ps]')
...
plt.title('Position of extrema together with fit - 500mW, small delays')
plt.xlabel('Wavelength [nm]')
plt.ylabel('Stage Delay [ps]')
...
plt.title('Chirp corrected data - 500mW, small delays')
plt.xlabel('Wavelength [nm]')
plt.ylabel('New time ???')
...
plt.title('Plot of Transient - 500mW, small delays')
...
plt.title('Plot of normalized Transient - 500mW, small delays')
plt.xlabel('Stage Delay [ps]')
