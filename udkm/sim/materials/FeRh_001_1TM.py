...
class FeRh_001_1TM:
    def __init__(self):
        ...
        self.prop['sound_vel'] = 5.100*u.nm/u.ps  # Calculated from elastic constant and density (5.283)
        ...
        self.prop['opt_pen_depth'] = 8*u.nm  # Roughly estimated from elispsometrie
    ...
    def createUnitCell(self, name, caxis, prop):
        ...
        IronRhodium.add_atom(self.Fe, 0)
        IronRhodium.add_atom(self.Rh, 0.5)
        return IronRhodium
