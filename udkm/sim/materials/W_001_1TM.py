...
class W_001_1TM:
    def __init__(self):
        ...
        self.prop['elastic_c11']    = 523.3e9*u.kg/(u.m*u.s**2) #(for 001 @300K) Featherston, Physical Review 130, 4, 1324-1333 (1963)
        self.prop['elastic_c12']    = 204.5e9*u.kg/(u.m*u.s**2) #(for 001 @300K) Featherston, Physical Review 130, 4, 1324-1333 (1963)
        self.prop['elastic_c13']    = 204.5e9*u.kg/(u.m*u.s**2) #(for 001 @300K) Featherston, Physical Review 130, 4, 1324-1333 (1963)
        self.prop['elastic_c33']    = 523.3e9*u.kg/(u.m*u.s**2) #(for 001 @300K) Featherston, Physical Review 130, 4, 1324-1333 (1963)
        ...
        self.prop['heat_capacity']  = 133*u.J/(u.kg *u.K) # White, Journal of Physical and Chemical Reference Data 13, 1251 (1984)
        self.prop['therm_cond']     = 170*u.W/(u.m *u.K)  # Hust, (No. PB-84-235878; NBSIR-84/3007). National Bureau of Standards, Boulder, CO (USA). Chemical Engineering Science Div. (1984)
        self.prop['opt_pen_depth']  = 8*u.nm #(800nm)
        self.prop['opt_ref_index']  = 3.56 + 2.73j #(800nm) Adachi, The Handbook on optical constants of metals (2012) p.277
