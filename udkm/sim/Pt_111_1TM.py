...
class Pt_111_1TM:
    def __init__(self):
        ...
        self.prop['elastic_c11']    = 386e9*u.kg/(u.m*u.s**2) #(for 011) Collard, Acta metall. mater. 40, 4, 699-702 (1992)
        self.prop['elastic_c12']    = 232e9*u.kg/(u.m*u.s**2) #(for 011) Collard, Acta metall. mater. 40, 4, 699-702 (1992)
        self.prop['elastic_c13']    = 232e9*u.kg/(u.m*u.s**2) #(for 011) Collard, Acta metall. mater. 40, 4, 699-702 (1992)
        self.prop['elastic_c33']    = 386e9*u.kg/(u.m*u.s**2) #(for 011) Collard, Acta metall. mater. 40, 4, 699-702 (1992)
